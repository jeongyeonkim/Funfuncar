...
public class HistoryActivity extends Activity{
    ...
    String name_1, birthday_1, sex_1, phone_num_1, blood_1;
    String result ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                alertDialogBuilder.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Intent intent_4 = new Intent(HistoryActivity.this, Newuser_2.class);
        ...
        btn_Unregistered.setOnClickListener(new Button.OnClickListener() {
            @Override public void onClick(View view) {
                AlertDialog.Builder alertDialogBuilder_2 = new AlertDialog.Builder(HistoryActivity.this);
                ...
                alertDialogBuilder_2.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                int permissionCheck = ContextCompat.checkSelfPermission(HistoryActivity.this, Manifest.permission.SEND_SMS);
                                if(permissionCheck == PackageManager.PERMISSION_DENIED){
                                    ActivityCompat.requestPermissions(HistoryActivity.this, new String[] {Manifest.permission.SEND_SMS},1);
                                    Toast.makeText(HistoryActivity.this,"권한을 허용하고 재전송해주세요",Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    Toast.makeText(HistoryActivity.this,"전송을 완료하였습니다",Toast.LENGTH_LONG).show();
                                }
                ...
                alertDialogBuilder_2.setNegativeButton("취소",
                        new DialogInterface.OnClickListener() {
                            public void onClick(
                                    DialogInterface dialog, int id) {
                                // 다이얼로그를 취소한다
                                Intent intent1 = new Intent(HistoryActivity.this, Newuser_3.class);
        ...
        btn_Accident.setOnClickListener(new Button.OnClickListener() {
            @Override public void onClick(View view) {
                ...
                // 도난 신고 SMS
                //송신 인텐트
                PendingIntent sentPI = PendingIntent.getBroadcast(HistoryActivity.this, 0, new Intent("SMS_SENT"), 0);
                //수신 인텐트
                PendingIntent recvPI = PendingIntent.getBroadcast(HistoryActivity.this, 0, new Intent("SMS_DELIVERED"), 0);
                ...
                mSMSManager = SmsManager.getDefault();
                mSMSManager.sendTextMessage("010-7767-1067",null, sms, sentPI, recvPI);
        ...
        btn_Remain.setOnClickListener(new Button.OnClickListener() {
            @Override public void onClick(View view) {
                AlertDialog.Builder alertDialogBuilder_4 = new AlertDialog.Builder(HistoryActivity.this);
    ...
    private void selectToDatabase() {
        ...
        class SelectData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(HistoryActivity.this, "Please Wait", null, true, true);
